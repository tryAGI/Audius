...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRemixersCountSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRemixersCountSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetRemixersCountSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetRemixersCountSecurityRequirement0,
                s_GetRemixersCountSecurityRequirement1,
            };
        partial void PrepareGetRemixersCountArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref string? trackId);
        partial void PrepareGetRemixersCountRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string? userId,
            string? trackId);
        partial void ProcessGetRemixersCountResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRemixersCountResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.RemixersCountResponse> GetRemixersCountAsync(
            string id,
        ...
        {
            var __response = await GetRemixersCountAsResponseAsync(
                id: id,
                userId: userId,
                trackId: trackId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.RemixersCountResponse>> GetRemixersCountAsResponseAsync(
            string id,
            string? userId = default,
            string? trackId = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRemixersCountArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRemixersCountSecurityRequirements,
                operationName: "GetRemixersCountAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("track_id", trackId)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRemixersCountRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetRemixersCount",
                                methodName: "GetRemixersCountAsync",
                                pathTemplate: "$\"/users/{id}/remixers/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRemixersCountResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRemixersCountResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.RemixersCountResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.RemixersCountResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.RemixersCountResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
