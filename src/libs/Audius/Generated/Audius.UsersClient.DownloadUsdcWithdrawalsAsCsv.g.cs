...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadUsdcWithdrawalsAsCsvSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadUsdcWithdrawalsAsCsvSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_DownloadUsdcWithdrawalsAsCsvSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_DownloadUsdcWithdrawalsAsCsvSecurityRequirement0,
                s_DownloadUsdcWithdrawalsAsCsvSecurityRequirement1,
            };
        partial void PrepareDownloadUsdcWithdrawalsAsCsvArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareDownloadUsdcWithdrawalsAsCsvRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDownloadUsdcWithdrawalsAsCsvResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DownloadUsdcWithdrawalsAsCsvAsync(
            string id,
        ...
        {
            await DownloadUsdcWithdrawalsAsCsvAsResponseAsync(
                id: id,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse> DownloadUsdcWithdrawalsAsCsvAsResponseAsync(
            string id,
            string? userId = default,
            string? encodedDataMessage = default,
            string? encodedDataSignature = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadUsdcWithdrawalsAsCsvArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadUsdcWithdrawalsAsCsvSecurityRequirements,
                operationName: "DownloadUsdcWithdrawalsAsCsvAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadUsdcWithdrawalsAsCsvRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadUsdcWithdrawalsAsCsv",
                                methodName: "DownloadUsdcWithdrawalsAsCsvAsync",
                                pathTemplate: "$\"/users/{id}/withdrawals/download\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadUsdcWithdrawalsAsCsvResponse(
                    httpClient: HttpClient,
                ...
                return new global::Audius.AutoSDKHttpResponse(
