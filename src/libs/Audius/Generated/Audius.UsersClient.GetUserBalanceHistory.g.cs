...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserBalanceHistorySecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserBalanceHistorySecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUserBalanceHistorySecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUserBalanceHistorySecurityRequirement0,
                s_GetUserBalanceHistorySecurityRequirement1,
            };
        partial void PrepareGetUserBalanceHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref global::System.DateTime? startTime,
            ref global::System.DateTime? endTime,
            ref global::Audius.GetUserBalanceHistoryGranularity? granularity,
            ref string? userId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetUserBalanceHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::System.DateTime? startTime,
            global::System.DateTime? endTime,
            global::Audius.GetUserBalanceHistoryGranularity? granularity,
            string? userId,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetUserBalanceHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserBalanceHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.BalanceHistoryResponse> GetUserBalanceHistoryAsync(
            string id,
        ...
        {
            var __response = await GetUserBalanceHistoryAsResponseAsync(
                id: id,
                startTime: startTime,
                endTime: endTime,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.BalanceHistoryResponse>> GetUserBalanceHistoryAsResponseAsync(
            string id,
            global::System.DateTime? startTime = default,
            global::System.DateTime? endTime = default,
            global::Audius.GetUserBalanceHistoryGranularity? granularity = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserBalanceHistoryArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserBalanceHistorySecurityRequirements,
                operationName: "GetUserBalanceHistoryAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUserBalanceHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetUserBalanceHistoryAsync",
                                pathTemplate: "$\"/users/{id}/balance/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUserBalanceHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserBalanceHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.BalanceHistoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.BalanceHistoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.BalanceHistoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
