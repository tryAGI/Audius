...
namespace Audius
{
    public partial class EventsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetEventCommentsSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetEventCommentsSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetEventCommentsSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetEventCommentsSecurityRequirement0,
                s_GetEventCommentsSecurityRequirement1,
            };
        partial void PrepareGetEventCommentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string eventId,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref global::Audius.GetEventCommentsSortMethod? sortMethod);
        partial void PrepareGetEventCommentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId,
            global::Audius.GetEventCommentsSortMethod? sortMethod);
        partial void ProcessGetEventCommentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEventCommentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TrackCommentsResponse> GetEventCommentsAsync(
            string eventId,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetEventCommentsAsResponseAsync(
                eventId: eventId,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TrackCommentsResponse>> GetEventCommentsAsResponseAsync(
            string eventId,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEventCommentsArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEventCommentsSecurityRequirements,
                operationName: "GetEventCommentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEventCommentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetEventCommentsAsync",
                                pathTemplate: "$\"/events/{eventId}/comments\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEventCommentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEventCommentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
