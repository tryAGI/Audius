...
namespace Audius
{
    ...
    {
        partial void PrepareGetVolumeLeadersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? from,
            ref string? to,
            ref int? offset,
            ref int? limit);
        partial void PrepareGetVolumeLeadersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? offset,
            int? limit);
        partial void ProcessGetVolumeLeadersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVolumeLeadersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.CoinsVolumeLeadersResponse> GetVolumeLeadersAsync(
            string? from = default,
            string? to = default,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetVolumeLeadersAsResponseAsync(
                from: from,
                to: to,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.CoinsVolumeLeadersResponse>> GetVolumeLeadersAsResponseAsync(
            string? from = default,
            string? to = default,
            int? offset = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetVolumeLeadersArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetVolumeLeadersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetVolumeLeaders",
                                methodName: "GetVolumeLeadersAsync",
                                pathTemplate: "\"/coins/volume-leaders\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetVolumeLeadersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetVolumeLeadersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.CoinsVolumeLeadersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.CoinsVolumeLeadersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.CoinsVolumeLeadersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
