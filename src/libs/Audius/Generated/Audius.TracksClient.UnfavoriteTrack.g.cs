...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnfavoriteTrackSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnfavoriteTrackSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnfavoriteTrackSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_UnfavoriteTrackSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_UnfavoriteTrackSecurityRequirement0,
                s_UnfavoriteTrackSecurityRequirement1,
                s_UnfavoriteTrackSecurityRequirement2,
            };
        partial void PrepareUnfavoriteTrackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackId,
            ref string userId);
        partial void PrepareUnfavoriteTrackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string trackId,
            string userId);
        partial void ProcessUnfavoriteTrackResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnfavoriteTrackResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UnfavoriteTrackAsync(
            string trackId,
            string userId,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UnfavoriteTrackAsResponseAsync(
                trackId: trackId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> UnfavoriteTrackAsResponseAsync(
            string trackId,
            string userId,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnfavoriteTrackArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnfavoriteTrackSecurityRequirements,
                operationName: "UnfavoriteTrackAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnfavoriteTrack",
                                methodName: "UnfavoriteTrackAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnfavoriteTrackResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnfavoriteTrackResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
