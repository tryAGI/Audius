...
namespace Audius
{
    ...
    public sealed partial class FanRemixContestEndingSoonNotificationActionData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FanRemixContestEndingSoonNotificationActionData" /> class.
        /// </summary>
...
#endif
        public FanRemixContestEndingSoonNotificationActionData(
            string entityUserId,
            string entityId)
        {
