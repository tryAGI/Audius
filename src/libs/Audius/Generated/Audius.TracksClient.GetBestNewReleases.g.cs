...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetBestNewReleasesSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetBestNewReleasesSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetBestNewReleasesSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetBestNewReleasesSecurityRequirement0,
                s_GetBestNewReleasesSecurityRequirement1,
            };
        partial void PrepareGetBestNewReleasesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? userId,
            ref global::Audius.GetBestNewReleasesWindow window,
            ref int? limit,
            ref bool? withUsers);
        partial void PrepareGetBestNewReleasesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? userId,
            global::Audius.GetBestNewReleasesWindow window,
            int? limit,
            bool? withUsers);
        partial void ProcessGetBestNewReleasesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBestNewReleasesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetBestNewReleasesAsync(
            global::Audius.GetBestNewReleasesWindow window,
        ...
        {
            var __response = await GetBestNewReleasesAsResponseAsync(
                window: window,
                userId: userId,
                limit: limit,
                withUsers: withUsers,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetBestNewReleasesAsResponseAsync(
            global::Audius.GetBestNewReleasesWindow window,
            string? userId = default,
            int? limit = default,
            bool? withUsers = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBestNewReleasesArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBestNewReleasesSecurityRequirements,
                operationName: "GetBestNewReleasesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddRequiredParameter("window", window.ToValueString())
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetBestNewReleasesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetBestNewReleases",
                                methodName: "GetBestNewReleasesAsync",
                                pathTemplate: "\"/tracks/best_new_releases\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBestNewReleasesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBestNewReleasesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
