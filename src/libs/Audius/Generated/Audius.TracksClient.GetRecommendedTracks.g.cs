...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRecommendedTracksSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRecommendedTracksSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetRecommendedTracksSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetRecommendedTracksSecurityRequirement0,
                s_GetRecommendedTracksSecurityRequirement1,
            };
        partial void PrepareGetRecommendedTracksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? genre,
            ref global::Audius.GetRecommendedTracksTime? time,
            global::System.Collections.Generic.IList<int>? exclusionList,
            ref string? userId);
        partial void PrepareGetRecommendedTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string? genre,
            global::Audius.GetRecommendedTracksTime? time,
            global::System.Collections.Generic.IList<int>? exclusionList,
            string? userId);
        partial void ProcessGetRecommendedTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRecommendedTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetRecommendedTracksAsync(
            int? limit = default,
        ...
        {
            var __response = await GetRecommendedTracksAsResponseAsync(
                limit: limit,
                genre: genre,
                time: time,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetRecommendedTracksAsResponseAsync(
            int? limit = default,
            string? genre = default,
            global::Audius.GetRecommendedTracksTime? time = default,
            global::System.Collections.Generic.IList<int>? exclusionList = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRecommendedTracksArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRecommendedTracksSecurityRequirements,
                operationName: "GetRecommendedTracksAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRecommendedTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetRecommendedTracks",
                                methodName: "GetRecommendedTracksAsync",
                                pathTemplate: "\"/tracks/recommended\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRecommendedTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRecommendedTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
