...
namespace Audius
{
    public partial class CommentsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_ReactToCommentSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_ReactToCommentSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_ReactToCommentSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_ReactToCommentSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_ReactToCommentSecurityRequirement0,
                s_ReactToCommentSecurityRequirement1,
                s_ReactToCommentSecurityRequirement2,
            };
        partial void PrepareReactToCommentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string commentId,
            ref string userId,
            global::Audius.ReactCommentRequestBody request);
        partial void PrepareReactToCommentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string commentId,
            string userId,
            global::Audius.ReactCommentRequestBody request);
        partial void ProcessReactToCommentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReactToCommentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> ReactToCommentAsync(
            string commentId,
            string userId,
        ...
        {
            var __response = await ReactToCommentAsResponseAsync(
                commentId: commentId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> ReactToCommentAsResponseAsync(
            string commentId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReactToCommentArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReactToCommentSecurityRequirements,
                operationName: "ReactToCommentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReactToCommentAsync",
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReactToCommentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ReactToCommentAsync(
                commentId: commentId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
