...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetSupporterSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetSupporterSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetSupporterSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetSupporterSecurityRequirement0,
                s_GetSupporterSecurityRequirement1,
            };
        partial void PrepareGetSupporterArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string supporterUserId,
            ref string? userId);
        partial void PrepareGetSupporterRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string supporterUserId,
            string? userId);
        partial void ProcessGetSupporterResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSupporterResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.GetSupporter> GetSupporterAsync(
            string id,
            string supporterUserId,
        ...
        {
            var __response = await GetSupporterAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.GetSupporter>> GetSupporterAsResponseAsync(
            string id,
            string supporterUserId,
            string? userId = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSupporterArguments(
                httpClient: HttpClient,
                id: ref id,
                supporterUserId: ref supporterUserId,
                userId: ref userId);


            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetSupporterSecurityRequirements,
                operationName: "GetSupporterAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audius.PathBuilder(
                                path: $"/users/{id}/supporters/{supporterUserId}",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSupporterAsync",
                                pathTemplate: "$\"/users/{id}/supporters/{supporterUserId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSupporterResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.GetSupporter.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.GetSupporter>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.GetSupporter.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
