...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetAiAttributedTracksByUserHandleSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetAiAttributedTracksByUserHandleSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetAiAttributedTracksByUserHandleSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetAiAttributedTracksByUserHandleSecurityRequirement0,
                s_GetAiAttributedTracksByUserHandleSecurityRequirement1,
            };
        partial void PrepareGetAiAttributedTracksByUserHandleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string handle,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref global::Audius.GetAiAttributedTracksByUserHandleSort? sort,
            ref string? query,
            ref global::Audius.GetAiAttributedTracksByUserHandleSortMethod? sortMethod,
            ref global::Audius.GetAiAttributedTracksByUserHandleSortDirection? sortDirection,
            ref global::Audius.GetAiAttributedTracksByUserHandleFilterTracks? filterTracks,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetAiAttributedTracksByUserHandleRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId,
            global::Audius.GetAiAttributedTracksByUserHandleSort? sort,
            string? query,
            global::Audius.GetAiAttributedTracksByUserHandleSortMethod? sortMethod,
            global::Audius.GetAiAttributedTracksByUserHandleSortDirection? sortDirection,
            global::Audius.GetAiAttributedTracksByUserHandleFilterTracks? filterTracks,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetAiAttributedTracksByUserHandleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAiAttributedTracksByUserHandleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.Tracks> GetAiAttributedTracksByUserHandleAsync(
            string handle,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetAiAttributedTracksByUserHandleAsResponseAsync(
                handle: handle,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.Tracks>> GetAiAttributedTracksByUserHandleAsResponseAsync(
            string handle,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAiAttributedTracksByUserHandleArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAiAttributedTracksByUserHandleSecurityRequirements,
                operationName: "GetAiAttributedTracksByUserHandleAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("filter_tracks", filterTracks?.ToValueString())
                                ;
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAiAttributedTracksByUserHandleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAiAttributedTracksByUserHandle",
                                methodName: "GetAiAttributedTracksByUserHandleAsync",
                                pathTemplate: "$\"/users/handle/{handle}/tracks/ai_attributed\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAiAttributedTracksByUserHandleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAiAttributedTracksByUserHandleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.Tracks.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.Tracks>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.Tracks.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
