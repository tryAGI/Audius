...
namespace Audius
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Audius.AutoSDKRetryOptions Retry { get; set; } = new global::Audius.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Audius.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Audius.IAutoSDKHook>();
        ...
        public global::Audius.AutoSDKClientOptions AddHook(
            global::Audius.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Audius.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Audius.AutoSDKClientOptions UseAuthorizationProvider(
            global::Audius.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Audius.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Audius.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Audius.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Audius.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Audius.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Audius.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Audius.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Audius.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Audius.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Audius.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Audius.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Audius.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Audius.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Audius.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Audius.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Audius.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Audius.AutoSDKClientOptions clientOptions,
            global::Audius.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Audius.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Audius.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Audius.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Audius.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Audius.IAutoSDKHook, global::Audius.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Audius.AutoSDKHookContext context)
        {
