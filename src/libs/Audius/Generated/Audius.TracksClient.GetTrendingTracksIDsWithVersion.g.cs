...
namespace Audius
{
    ...
    {
        partial void PrepareGetTrendingTracksIDsWithVersionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string version,
            ref int? offset,
            ref int? limit,
            ref string? genre);
        partial void PrepareGetTrendingTracksIDsWithVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? genre);
        partial void ProcessGetTrendingTracksIDsWithVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTrendingTracksIDsWithVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TrendingIdsResponse> GetTrendingTracksIDsWithVersionAsync(
            string version,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetTrendingTracksIDsWithVersionAsResponseAsync(
                version: version,
                offset: offset,
                limit: limit,
                genre: genre,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TrendingIdsResponse>> GetTrendingTracksIDsWithVersionAsResponseAsync(
            string version,
            int? offset = default,
            int? limit = default,
            string? genre = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTrendingTracksIDsWithVersionArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTrendingTracksIDsWithVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTrendingTracksIDsWithVersion",
                                methodName: "GetTrendingTracksIDsWithVersionAsync",
                                pathTemplate: "$\"/tracks/trending/ids/{version}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTrendingTracksIDsWithVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTrendingTracksIDsWithVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.TrendingIdsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.TrendingIdsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.TrendingIdsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
