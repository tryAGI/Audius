...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_RecordTrackDownloadSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_RecordTrackDownloadSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_RecordTrackDownloadSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_RecordTrackDownloadSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_RecordTrackDownloadSecurityRequirement0,
                s_RecordTrackDownloadSecurityRequirement1,
                s_RecordTrackDownloadSecurityRequirement2,
            };
        partial void PrepareRecordTrackDownloadArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackId,
            ref string? userId,
            global::Audius.TrackDownloadRequestBody request);
        partial void PrepareRecordTrackDownloadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string trackId,
            string? userId,
            global::Audius.TrackDownloadRequestBody request);
        partial void ProcessRecordTrackDownloadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRecordTrackDownloadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> RecordTrackDownloadAsync(
            string trackId,
        ...
        {
            var __response = await RecordTrackDownloadAsResponseAsync(
                trackId: trackId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> RecordTrackDownloadAsResponseAsync(
            string trackId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRecordTrackDownloadArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RecordTrackDownloadSecurityRequirements,
                operationName: "RecordTrackDownloadAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRecordTrackDownloadRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RecordTrackDownload",
                                methodName: "RecordTrackDownloadAsync",
                                pathTemplate: "$\"/tracks/{trackId}/downloads\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRecordTrackDownloadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRecordTrackDownloadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> RecordTrackDownloadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audius.TrackDownloadRequestBody
            {
                City = city,
                Region = region,
                Country = country,
            ...
            return await RecordTrackDownloadAsync(
                trackId: trackId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
