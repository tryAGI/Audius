...
namespace Audius
{
    ...
    {
        partial void PrepareGetCoinMembersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string mint,
            ref int? offset,
            ref int? limit,
            ref global::Audius.GetCoinMembersSortDirection? sortDirection);
        partial void PrepareGetCoinMembersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string mint,
            int? offset,
            int? limit,
            global::Audius.GetCoinMembersSortDirection? sortDirection);
        partial void ProcessGetCoinMembersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCoinMembersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.CoinMembersResponse> GetCoinMembersAsync(
            string mint,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetCoinMembersAsResponseAsync(
                mint: mint,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.CoinMembersResponse>> GetCoinMembersAsResponseAsync(
            string mint,
            int? offset = default,
            int? limit = default,
            global::Audius.GetCoinMembersSortDirection? sortDirection = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCoinMembersArguments(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetCoinMembers",
                                methodName: "GetCoinMembersAsync",
                                pathTemplate: "$\"/coins/{mint}/members\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCoinMembersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.CoinMembersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.CoinMembersResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.CoinMembersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
