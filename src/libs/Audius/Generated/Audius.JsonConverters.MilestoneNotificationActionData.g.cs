...
{
    /// <inheritdoc />
    public class MilestoneNotificationActionDataJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Audius.MilestoneNotificationActionData>
    {
        /// <inheritdoc />
        public override global::Audius.MilestoneNotificationActionData Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("track_id")) __score1++;
            if (__jsonProps.Contains("type")) __score1++;
            var __score2 = 0;
            if (__jsonProps.Contains("is_album")) __score2++;
            if (__jsonProps.Contains("playlist_id")) __score2++;
            if (__jsonProps.Contains("threshold")) __score2++;
            ...
            global::Audius.UserMilestoneNotificationActionData? user = default;
            global::Audius.TrackMilestoneNotificationActionData? track = default;
            global::Audius.PlaylistMilestoneNotificationActionData? playlist = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (user == null && track == null && playlist == null)
            {
                try
                {
            ...
            var __value = new global::Audius.MilestoneNotificationActionData(
                user,
        ...
        public override void Write(
            ...
            global::Audius.MilestoneNotificationActionData value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
