...
namespace Audius
{
    public partial class EventsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetEventFollowersSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetEventFollowersSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetEventFollowersSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetEventFollowersSecurityRequirement0,
                s_GetEventFollowersSecurityRequirement1,
            };
        partial void PrepareGetEventFollowersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string eventId,
            ref int? offset,
            ref int? limit,
            ref string? userId);
        partial void PrepareGetEventFollowersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId);
        partial void ProcessGetEventFollowersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetEventFollowersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.FollowersResponse> GetEventFollowersAsync(
            string eventId,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetEventFollowersAsResponseAsync(
                eventId: eventId,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.FollowersResponse>> GetEventFollowersAsResponseAsync(
            string eventId,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetEventFollowersArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetEventFollowersSecurityRequirements,
                operationName: "GetEventFollowersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetEventFollowersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetEventFollowers",
                                methodName: "GetEventFollowersAsync",
                                pathTemplate: "$\"/events/{eventId}/followers\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetEventFollowersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetEventFollowersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.FollowersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.FollowersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.FollowersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
