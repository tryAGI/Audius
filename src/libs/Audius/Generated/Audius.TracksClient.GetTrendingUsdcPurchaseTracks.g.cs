...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTrendingUsdcPurchaseTracksSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTrendingUsdcPurchaseTracksSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetTrendingUsdcPurchaseTracksSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetTrendingUsdcPurchaseTracksSecurityRequirement0,
                s_GetTrendingUsdcPurchaseTracksSecurityRequirement1,
            };
        partial void PrepareGetTrendingUsdcPurchaseTracksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref string? genre,
            ref global::Audius.GetTrendingUsdcPurchaseTracksTime? time);
        partial void PrepareGetTrendingUsdcPurchaseTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? genre,
            global::Audius.GetTrendingUsdcPurchaseTracksTime? time);
        partial void ProcessGetTrendingUsdcPurchaseTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTrendingUsdcPurchaseTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetTrendingUsdcPurchaseTracksAsync(
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetTrendingUsdcPurchaseTracksAsResponseAsync(
                offset: offset,
                limit: limit,
                userId: userId,
                genre: genre,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetTrendingUsdcPurchaseTracksAsResponseAsync(
            int? offset = default,
            int? limit = default,
            string? userId = default,
            string? genre = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTrendingUsdcPurchaseTracksArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTrendingUsdcPurchaseTracksSecurityRequirements,
                operationName: "GetTrendingUsdcPurchaseTracksAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTrendingUsdcPurchaseTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTrendingUsdcPurchaseTracks",
                                methodName: "GetTrendingUsdcPurchaseTracksAsync",
                                pathTemplate: "\"/tracks/usdc-purchase\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTrendingUsdcPurchaseTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTrendingUsdcPurchaseTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
