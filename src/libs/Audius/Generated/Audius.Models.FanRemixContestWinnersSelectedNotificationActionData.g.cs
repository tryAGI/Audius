...
namespace Audius
{
    ...
    public sealed partial class FanRemixContestWinnersSelectedNotificationActionData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FanRemixContestWinnersSelectedNotificationActionData" /> class.
        /// </summary>
...
#endif
        public FanRemixContestWinnersSelectedNotificationActionData(
            string entityUserId,
            string entityId)
        {
