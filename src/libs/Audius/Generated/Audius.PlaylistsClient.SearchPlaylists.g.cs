...
namespace Audius
{
    ...
    {
        partial void PrepareSearchPlaylistsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit,
            ref string? query,
            global::System.Collections.Generic.IList<string>? genre,
            ref global::Audius.SearchPlaylistsSortMethod? sortMethod,
            global::System.Collections.Generic.IList<string>? mood,
            ref string? includePurchaseable,
            ref string? hasDownloads);
        partial void PrepareSearchPlaylistsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? query,
            global::System.Collections.Generic.IList<string>? genre,
            global::Audius.SearchPlaylistsSortMethod? sortMethod,
            global::System.Collections.Generic.IList<string>? mood,
            string? includePurchaseable,
            string? hasDownloads);
        partial void ProcessSearchPlaylistsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchPlaylistsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.PlaylistSearchResult> SearchPlaylistsAsync(
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await SearchPlaylistsAsResponseAsync(
                offset: offset,
                limit: limit,
                query: query,
                genre: genre,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.PlaylistSearchResult>> SearchPlaylistsAsResponseAsync(
            int? offset = default,
            int? limit = default,
            string? query = default,
            global::System.Collections.Generic.IList<string>? genre = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSearchPlaylistsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("includePurchaseable", includePurchaseable)
                                .AddOptionalParameter("has_downloads", hasDownloads)
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchPlaylistsAsync",
                                pathTemplate: "\"/playlists/search\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchPlaylistsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchPlaylistsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.PlaylistSearchResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.PlaylistSearchResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.PlaylistSearchResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
