...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserTrackHistorySecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserTrackHistorySecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUserTrackHistorySecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUserTrackHistorySecurityRequirement0,
                s_GetUserTrackHistorySecurityRequirement1,
            };
        partial void PrepareGetUserTrackHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? offset,
            ref int? limit,
            ref string? query,
            ref global::Audius.GetUserTrackHistorySortMethod? sortMethod,
            ref global::Audius.GetUserTrackHistorySortDirection? sortDirection,
            ref string? userId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetUserTrackHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? query,
            global::Audius.GetUserTrackHistorySortMethod? sortMethod,
            global::Audius.GetUserTrackHistorySortDirection? sortDirection,
            string? userId,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetUserTrackHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserTrackHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.HistoryResponse> GetUserTrackHistoryAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUserTrackHistoryAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                query: query,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.HistoryResponse>> GetUserTrackHistoryAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? query = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserTrackHistoryArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserTrackHistorySecurityRequirements,
                operationName: "GetUserTrackHistoryAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUserTrackHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUserTrackHistory",
                                methodName: "GetUserTrackHistoryAsync",
                                pathTemplate: "$\"/users/{id}/history/tracks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUserTrackHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserTrackHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.HistoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.HistoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.HistoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
