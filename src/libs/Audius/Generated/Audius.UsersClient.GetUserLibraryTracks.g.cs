...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryTracksSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryTracksSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUserLibraryTracksSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUserLibraryTracksSecurityRequirement0,
                s_GetUserLibraryTracksSecurityRequirement1,
            };
        partial void PrepareGetUserLibraryTracksArguments(
            ...
            ref string? userId,
            ref string? query,
            ref global::Audius.GetUserLibraryTracksSortMethod? sortMethod,
            ref global::Audius.GetUserLibraryTracksSortDirection? sortDirection,
            ref global::Audius.GetUserLibraryTracksType? type,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetUserLibraryTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? query,
            global::Audius.GetUserLibraryTracksSortMethod? sortMethod,
            global::Audius.GetUserLibraryTracksSortDirection? sortDirection,
            global::Audius.GetUserLibraryTracksType? type,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetUserLibraryTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserLibraryTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TrackLibraryResponse> GetUserLibraryTracksAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUserLibraryTracksAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TrackLibraryResponse>> GetUserLibraryTracksAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserLibraryTracksArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserLibraryTracksSecurityRequirements,
                operationName: "GetUserLibraryTracksAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUserLibraryTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUserLibraryTracks",
                                methodName: "GetUserLibraryTracksAsync",
                                pathTemplate: "$\"/users/{id}/library/tracks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUserLibraryTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserLibraryTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.TrackLibraryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.TrackLibraryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.TrackLibraryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
