...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUndergroundTrendingTracksWithVersionSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUndergroundTrendingTracksWithVersionSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUndergroundTrendingTracksWithVersionSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUndergroundTrendingTracksWithVersionSecurityRequirement0,
                s_GetUndergroundTrendingTracksWithVersionSecurityRequirement1,
            };
        partial void PrepareGetUndergroundTrendingTracksWithVersionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string version,
            ref int? offset,
            ref int? limit,
            ref string? userId);
        partial void PrepareGetUndergroundTrendingTracksWithVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId);
        partial void ProcessGetUndergroundTrendingTracksWithVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUndergroundTrendingTracksWithVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetUndergroundTrendingTracksWithVersionAsync(
            string version,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUndergroundTrendingTracksWithVersionAsResponseAsync(
                version: version,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetUndergroundTrendingTracksWithVersionAsResponseAsync(
            string version,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUndergroundTrendingTracksWithVersionArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUndergroundTrendingTracksWithVersionSecurityRequirements,
                operationName: "GetUndergroundTrendingTracksWithVersionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUndergroundTrendingTracksWithVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUndergroundTrendingTracksWithVersion",
                                methodName: "GetUndergroundTrendingTracksWithVersionAsync",
                                pathTemplate: "$\"/tracks/trending/underground/{version}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUndergroundTrendingTracksWithVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUndergroundTrendingTracksWithVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
