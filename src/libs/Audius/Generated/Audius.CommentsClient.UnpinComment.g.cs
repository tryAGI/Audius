...
namespace Audius
{
    public partial class CommentsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnpinCommentSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnpinCommentSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnpinCommentSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_UnpinCommentSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_UnpinCommentSecurityRequirement0,
                s_UnpinCommentSecurityRequirement1,
                s_UnpinCommentSecurityRequirement2,
            };
        partial void PrepareUnpinCommentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string commentId,
            ref string userId,
            global::Audius.PinCommentRequestBody request);
        partial void PrepareUnpinCommentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string commentId,
            string userId,
            global::Audius.PinCommentRequestBody request);
        partial void ProcessUnpinCommentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnpinCommentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UnpinCommentAsync(
            string commentId,
            string userId,
        ...
        {
            var __response = await UnpinCommentAsResponseAsync(
                commentId: commentId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> UnpinCommentAsResponseAsync(
            string commentId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnpinCommentSecurityRequirements,
                operationName: "UnpinCommentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UnpinCommentAsync",
                                pathTemplate: "$\"/comments/{commentId}/pin\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnpinCommentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UnpinCommentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audius.PinCommentRequestBody
            {
                EntityType = entityType,
                EntityId = entityId,
            };

            return await UnpinCommentAsync(
                commentId: commentId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
