...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryAlbumsSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryAlbumsSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUserLibraryAlbumsSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUserLibraryAlbumsSecurityRequirement0,
                s_GetUserLibraryAlbumsSecurityRequirement1,
            };
        partial void PrepareGetUserLibraryAlbumsArguments(
            ...
            ref string? userId,
            ref string? query,
            ref global::Audius.GetUserLibraryAlbumsSortDirection? sortDirection,
            ref global::Audius.GetUserLibraryAlbumsType? type,
            ref global::Audius.GetUserLibraryAlbumsSortMethod? sortMethod,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetUserLibraryAlbumsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? query,
            global::Audius.GetUserLibraryAlbumsSortDirection? sortDirection,
            global::Audius.GetUserLibraryAlbumsType? type,
            global::Audius.GetUserLibraryAlbumsSortMethod? sortMethod,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetUserLibraryAlbumsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserLibraryAlbumsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.CollectionLibraryResponse> GetUserLibraryAlbumsAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUserLibraryAlbumsAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.CollectionLibraryResponse>> GetUserLibraryAlbumsAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserLibraryAlbumsArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserLibraryAlbumsSecurityRequirements,
                operationName: "GetUserLibraryAlbumsAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUserLibraryAlbumsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUserLibraryAlbums",
                                methodName: "GetUserLibraryAlbumsAsync",
                                pathTemplate: "$\"/users/{id}/library/albums\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUserLibraryAlbumsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserLibraryAlbumsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
