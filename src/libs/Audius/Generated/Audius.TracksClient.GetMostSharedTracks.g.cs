...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetMostSharedTracksSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetMostSharedTracksSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetMostSharedTracksSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetMostSharedTracksSecurityRequirement0,
                s_GetMostSharedTracksSecurityRequirement1,
            };
        partial void PrepareGetMostSharedTracksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? userId,
            ref int? limit,
            ref int? offset,
            ref global::Audius.GetMostSharedTracksTimeRange? timeRange);
        partial void PrepareGetMostSharedTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? userId,
            int? limit,
            int? offset,
            global::Audius.GetMostSharedTracksTimeRange? timeRange);
        partial void ProcessGetMostSharedTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMostSharedTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetMostSharedTracksAsync(
            string? userId = default,
            int? limit = default,
            int? offset = default,
            global::Audius.GetMostSharedTracksTimeRange? timeRange = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetMostSharedTracksAsResponseAsync(
                userId: userId,
                limit: limit,
                offset: offset,
                timeRange: timeRange,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetMostSharedTracksAsResponseAsync(
            string? userId = default,
            int? limit = default,
            int? offset = default,
            global::Audius.GetMostSharedTracksTimeRange? timeRange = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMostSharedTracksArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetMostSharedTracksSecurityRequirements,
                operationName: "GetMostSharedTracksAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetMostSharedTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetMostSharedTracks",
                                methodName: "GetMostSharedTracksAsync",
                                pathTemplate: "\"/tracks/most-shared\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetMostSharedTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetMostSharedTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
