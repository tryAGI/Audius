...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetSupportingSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetSupportingSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetSupportingSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetSupportingSecurityRequirement0,
                s_GetSupportingSecurityRequirement1,
            };
        partial void PrepareGetSupportingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string supportedUserId,
            ref string? userId);
        partial void PrepareGetSupportingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string supportedUserId,
            string? userId);
        partial void ProcessGetSupportingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSupportingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.GetSupporting> GetSupportingAsync(
            string id,
            string supportedUserId,
        ...
        {
            var __response = await GetSupportingAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.GetSupporting>> GetSupportingAsResponseAsync(
            string id,
            string supportedUserId,
            string? userId = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSupportingArguments(
                httpClient: HttpClient,
                id: ref id,
                supportedUserId: ref supportedUserId,
                userId: ref userId);


            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetSupportingSecurityRequirements,
                operationName: "GetSupportingAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audius.PathBuilder(
                                path: $"/users/{id}/supporting/{supportedUserId}",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSupporting",
                                methodName: "GetSupportingAsync",
                                pathTemplate: "$\"/users/{id}/supporting/{supportedUserId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSupportingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.GetSupporting.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.GetSupporting>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.GetSupporting.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
