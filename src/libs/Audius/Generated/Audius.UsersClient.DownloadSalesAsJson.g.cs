...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadSalesAsJsonSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadSalesAsJsonSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_DownloadSalesAsJsonSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_DownloadSalesAsJsonSecurityRequirement0,
                s_DownloadSalesAsJsonSecurityRequirement1,
            };
        partial void PrepareDownloadSalesAsJsonArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref string? granteeUserId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareDownloadSalesAsJsonRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDownloadSalesAsJsonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDownloadSalesAsJsonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.SalesJsonResponse> DownloadSalesAsJsonAsync(
            string id,
            string? userId = default,
            string? granteeUserId = default,
            string? encodedDataMessage = default,
            string? encodedDataSignature = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DownloadSalesAsJsonAsResponseAsync(
                id: id,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.SalesJsonResponse>> DownloadSalesAsJsonAsResponseAsync(
            string id,
            string? userId = default,
            string? granteeUserId = default,
            string? encodedDataMessage = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadSalesAsJsonArguments(
                httpClient: HttpClient,
                id: ref id,
                userId: ref userId,
                granteeUserId: ref granteeUserId,
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadSalesAsJsonSecurityRequirements,
                operationName: "DownloadSalesAsJsonAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("grantee_user_id", granteeUserId)
                                ;
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadSalesAsJsonRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadSalesAsJson",
                                methodName: "DownloadSalesAsJsonAsync",
                                pathTemplate: "$\"/users/{id}/sales/download/json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadSalesAsJsonResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDownloadSalesAsJsonResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.SalesJsonResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.SalesJsonResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.SalesJsonResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
