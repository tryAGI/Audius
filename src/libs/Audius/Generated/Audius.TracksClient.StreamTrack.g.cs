...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_StreamTrackSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_StreamTrackSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_StreamTrackSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_StreamTrackSecurityRequirement0,
                s_StreamTrackSecurityRequirement1,
            };
        partial void PrepareStreamTrackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackId,
            ref string? userId,
            ref bool? preview,
            ref string? userSignature,
            ref string? userData,
            ref string? nftAccessSignature,
            ref bool? skipPlayCount,
            ref string? apiKey,
            ref bool? skipCheck,
            ref bool? noRedirect);
        partial void PrepareStreamTrackRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userData,
            string? nftAccessSignature,
            bool? skipPlayCount,
            string? apiKey,
            bool? skipCheck,
            bool? noRedirect);
        partial void ProcessStreamTrackResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStreamTrackResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.StreamUrlResponse> StreamTrackAsync(
            string trackId,
        ...
        {
            var __response = await StreamTrackAsResponseAsync(
                trackId: trackId,
                userId: userId,
                preview: preview,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.StreamUrlResponse>> StreamTrackAsResponseAsync(
            string trackId,
            string? userId = default,
            bool? preview = default,
            string? userSignature = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStreamTrackArguments(
                httpClient: HttpClient,
                trackId: ref trackId,
                userId: ref userId,
                preview: ref preview,
                userSignature: ref userSignature,
                userData: ref userData,
                nftAccessSignature: ref nftAccessSignature,
                skipPlayCount: ref skipPlayCount,
                apiKey: ref apiKey,
                skipCheck: ref skipCheck,
                noRedirect: ref noRedirect);


            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_StreamTrackSecurityRequirements,
                operationName: "StreamTrackAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("preview", preview?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("user_signature", userSignature)
                                .AddOptionalParameter("user_data", userData)
                                .AddOptionalParameter("nft_access_signature", nftAccessSignature)
                                .AddOptionalParameter("skip_play_count", skipPlayCount?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("api_key", apiKey)
                                .AddOptionalParameter("skip_check", skipCheck?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("no_redirect", noRedirect?.ToString().ToLowerInvariant())
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "StreamTrackAsync",
                                pathTemplate: "$\"/tracks/{trackId}/stream\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStreamTrackResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.StreamUrlResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.StreamUrlResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.StreamUrlResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
