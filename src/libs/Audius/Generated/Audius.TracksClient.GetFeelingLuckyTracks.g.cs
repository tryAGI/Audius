...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetFeelingLuckyTracksSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetFeelingLuckyTracksSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetFeelingLuckyTracksSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetFeelingLuckyTracksSecurityRequirement0,
                s_GetFeelingLuckyTracksSecurityRequirement1,
            };
        partial void PrepareGetFeelingLuckyTracksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? userId,
            ref int? limit,
            ref bool? withUsers,
            ref int? minFollowers);
        partial void PrepareGetFeelingLuckyTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? withUsers,
            int? minFollowers);
        partial void ProcessGetFeelingLuckyTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFeelingLuckyTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetFeelingLuckyTracksAsync(
        ...
        {
            var __response = await GetFeelingLuckyTracksAsResponseAsync(
                userId: userId,
                limit: limit,
                withUsers: withUsers,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetFeelingLuckyTracksAsResponseAsync(
            string? userId = default,
            int? limit = default,
            bool? withUsers = default,
            int? minFollowers = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFeelingLuckyTracksArguments(
                httpClient: HttpClient,
                userId: ref userId,
                limit: ref limit,
                withUsers: ref withUsers,
                minFollowers: ref minFollowers);


            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetFeelingLuckyTracksSecurityRequirements,
                operationName: "GetFeelingLuckyTracksAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("min_followers", minFollowers?.ToString())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFeelingLuckyTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetFeelingLuckyTracks",
                                methodName: "GetFeelingLuckyTracksAsync",
                                pathTemplate: "\"/tracks/feeling-lucky\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFeelingLuckyTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFeelingLuckyTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
