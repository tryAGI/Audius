...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadSalesAsCsvSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadSalesAsCsvSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_DownloadSalesAsCsvSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_DownloadSalesAsCsvSecurityRequirement0,
                s_DownloadSalesAsCsvSecurityRequirement1,
            };
        partial void PrepareDownloadSalesAsCsvArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareDownloadSalesAsCsvRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDownloadSalesAsCsvResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DownloadSalesAsCsvAsync(
            string id,
        ...
        {
            await DownloadSalesAsCsvAsResponseAsync(
                id: id,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse> DownloadSalesAsCsvAsResponseAsync(
            string id,
            string? userId = default,
            string? encodedDataMessage = default,
            string? encodedDataSignature = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadSalesAsCsvArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadSalesAsCsvSecurityRequirements,
                operationName: "DownloadSalesAsCsvAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadSalesAsCsvRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadSalesAsCsv",
                                methodName: "DownloadSalesAsCsvAsync",
                                pathTemplate: "$\"/users/{id}/sales/download\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadSalesAsCsvResponse(
                    httpClient: HttpClient,
