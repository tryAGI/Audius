...
namespace Audius
{
    public partial class CommentsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnreactToCommentSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnreactToCommentSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_UnreactToCommentSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_UnreactToCommentSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_UnreactToCommentSecurityRequirement0,
                s_UnreactToCommentSecurityRequirement1,
                s_UnreactToCommentSecurityRequirement2,
            };
        partial void PrepareUnreactToCommentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string commentId,
            ref string userId,
            global::Audius.ReactCommentRequestBody request);
        partial void PrepareUnreactToCommentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string commentId,
            string userId,
            global::Audius.ReactCommentRequestBody request);
        partial void ProcessUnreactToCommentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnreactToCommentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UnreactToCommentAsync(
            string commentId,
            string userId,
        ...
        {
            var __response = await UnreactToCommentAsResponseAsync(
                commentId: commentId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> UnreactToCommentAsResponseAsync(
            string commentId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUnreactToCommentArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnreactToCommentSecurityRequirements,
                operationName: "UnreactToCommentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnreactToCommentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UnreactToCommentAsync",
                                pathTemplate: "$\"/comments/{commentId}/react\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnreactToCommentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnreactToCommentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UnreactToCommentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audius.ReactCommentRequestBody
            {
                EntityType = entityType,
                EntityId = entityId,
            };

            return await UnreactToCommentAsync(
                commentId: commentId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
