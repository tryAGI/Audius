...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTrendingTracksWithVersionSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTrendingTracksWithVersionSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetTrendingTracksWithVersionSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetTrendingTracksWithVersionSecurityRequirement0,
                s_GetTrendingTracksWithVersionSecurityRequirement1,
            };
        partial void PrepareGetTrendingTracksWithVersionArguments(
            ...
            ref string? userId,
            ref string? genre,
            ref global::Audius.GetTrendingTracksWithVersionTime? time);
        partial void PrepareGetTrendingTracksWithVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? genre,
            global::Audius.GetTrendingTracksWithVersionTime? time);
        partial void ProcessGetTrendingTracksWithVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTrendingTracksWithVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetTrendingTracksWithVersionAsync(
            string version,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            string? genre = default,
            global::Audius.GetTrendingTracksWithVersionTime? time = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTrendingTracksWithVersionAsResponseAsync(
                version: version,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetTrendingTracksWithVersionAsResponseAsync(
            string version,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTrendingTracksWithVersionArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTrendingTracksWithVersionSecurityRequirements,
                operationName: "GetTrendingTracksWithVersionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTrendingTracksWithVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTrendingTracksWithVersion",
                                methodName: "GetTrendingTracksWithVersionAsync",
                                pathTemplate: "$\"/tracks/trending/{version}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTrendingTracksWithVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTrendingTracksWithVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
