...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadPurchasesAsCsvSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_DownloadPurchasesAsCsvSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_DownloadPurchasesAsCsvSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_DownloadPurchasesAsCsvSecurityRequirement0,
                s_DownloadPurchasesAsCsvSecurityRequirement1,
            };
        partial void PrepareDownloadPurchasesAsCsvArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareDownloadPurchasesAsCsvRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDownloadPurchasesAsCsvResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DownloadPurchasesAsCsvAsync(
            string id,
        ...
        {
            await DownloadPurchasesAsCsvAsResponseAsync(
                id: id,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse> DownloadPurchasesAsCsvAsResponseAsync(
            string id,
            string? userId = default,
            string? encodedDataMessage = default,
            string? encodedDataSignature = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadPurchasesAsCsvArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DownloadPurchasesAsCsvSecurityRequirements,
                operationName: "DownloadPurchasesAsCsvAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadPurchasesAsCsvRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadPurchasesAsCsv",
                                methodName: "DownloadPurchasesAsCsvAsync",
                                pathTemplate: "$\"/users/{id}/purchases/download\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadPurchasesAsCsvResponse(
                    httpClient: HttpClient,
