...
namespace Audius
{
    ...
    {
        partial void PrepareGetAudioTransactionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? offset,
            ref int? limit,
            ref global::Audius.GetAudioTransactionsSortMethod? sortMethod,
            ref global::Audius.GetAudioTransactionsSortDirection? sortDirection,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetAudioTransactionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            int? offset,
            int? limit,
            global::Audius.GetAudioTransactionsSortMethod? sortMethod,
            global::Audius.GetAudioTransactionsSortDirection? sortDirection,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetAudioTransactionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAudioTransactionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TransactionHistoryResponse> GetAudioTransactionsAsync(
            string id,
            int? offset = default,
            int? limit = default,
            global::Audius.GetAudioTransactionsSortMethod? sortMethod = default,
            global::Audius.GetAudioTransactionsSortDirection? sortDirection = default,
            string? encodedDataMessage = default,
            string? encodedDataSignature = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAudioTransactionsAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TransactionHistoryResponse>> GetAudioTransactionsAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            global::Audius.GetAudioTransactionsSortMethod? sortMethod = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAudioTransactionsArguments(
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAudioTransactionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAudioTransactions",
                                methodName: "GetAudioTransactionsAsync",
                                pathTemplate: "$\"/users/{id}/transactions/audio\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAudioTransactionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAudioTransactionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
