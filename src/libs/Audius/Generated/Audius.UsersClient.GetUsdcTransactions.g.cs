...
namespace Audius
{
    ...
    {
        partial void PrepareGetUsdcTransactionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? offset,
            ref int? limit,
            ref global::Audius.GetUsdcTransactionsSortMethod? sortMethod,
            ref global::Audius.GetUsdcTransactionsSortDirection? sortDirection,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature,
            global::System.Collections.Generic.IList<global::Audius.GetUsdcTransactionsTypeItem>? type,
            ref bool? includeSystemTransactions,
            ref global::Audius.GetUsdcTransactionsMethod? method);
        partial void PrepareGetUsdcTransactionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            int? offset,
            int? limit,
            global::Audius.GetUsdcTransactionsSortMethod? sortMethod,
            global::Audius.GetUsdcTransactionsSortDirection? sortDirection,
            string? encodedDataMessage,
            string? encodedDataSignature,
            global::System.Collections.Generic.IList<global::Audius.GetUsdcTransactionsTypeItem>? type,
            bool? includeSystemTransactions,
            global::Audius.GetUsdcTransactionsMethod? method);
        partial void ProcessGetUsdcTransactionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUsdcTransactionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TransactionHistoryResponse> GetUsdcTransactionsAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUsdcTransactionsAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TransactionHistoryResponse>> GetUsdcTransactionsAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            global::Audius.GetUsdcTransactionsSortMethod? sortMethod = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUsdcTransactionsArguments(
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUsdcTransactionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUsdcTransactions",
                                methodName: "GetUsdcTransactionsAsync",
                                pathTemplate: "$\"/users/{id}/transactions/usdc\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUsdcTransactionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUsdcTransactionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.TransactionHistoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.TransactionHistoryResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.TransactionHistoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
