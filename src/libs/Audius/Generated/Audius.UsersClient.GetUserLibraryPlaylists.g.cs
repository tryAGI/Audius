...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryPlaylistsSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetUserLibraryPlaylistsSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetUserLibraryPlaylistsSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetUserLibraryPlaylistsSecurityRequirement0,
                s_GetUserLibraryPlaylistsSecurityRequirement1,
            };
        partial void PrepareGetUserLibraryPlaylistsArguments(
            ...
            ref string? userId,
            ref string? query,
            ref global::Audius.GetUserLibraryPlaylistsSortDirection? sortDirection,
            ref global::Audius.GetUserLibraryPlaylistsType? type,
            ref global::Audius.GetUserLibraryPlaylistsSortMethod? sortMethod,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetUserLibraryPlaylistsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? query,
            global::Audius.GetUserLibraryPlaylistsSortDirection? sortDirection,
            global::Audius.GetUserLibraryPlaylistsType? type,
            global::Audius.GetUserLibraryPlaylistsSortMethod? sortMethod,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetUserLibraryPlaylistsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserLibraryPlaylistsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.CollectionLibraryResponse> GetUserLibraryPlaylistsAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetUserLibraryPlaylistsAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.CollectionLibraryResponse>> GetUserLibraryPlaylistsAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserLibraryPlaylistsArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserLibraryPlaylistsSecurityRequirements,
                operationName: "GetUserLibraryPlaylistsAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUserLibraryPlaylistsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetUserLibraryPlaylists",
                                methodName: "GetUserLibraryPlaylistsAsync",
                                pathTemplate: "$\"/users/{id}/library/playlists\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUserLibraryPlaylistsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserLibraryPlaylistsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.CollectionLibraryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.CollectionLibraryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.CollectionLibraryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
