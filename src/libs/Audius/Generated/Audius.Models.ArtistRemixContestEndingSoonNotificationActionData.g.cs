...
namespace Audius
{
    ...
    public sealed partial class ArtistRemixContestEndingSoonNotificationActionData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtistRemixContestEndingSoonNotificationActionData" /> class.
        /// </summary>
...
#endif
        public ArtistRemixContestEndingSoonNotificationActionData(
            string entityUserId,
            string entityId)
        {
