...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTracksCountByUserSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTracksCountByUserSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetTracksCountByUserSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetTracksCountByUserSecurityRequirement0,
                s_GetTracksCountByUserSecurityRequirement1,
            };
        partial void PrepareGetTracksCountByUserArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? userId,
            ref global::Audius.GetTracksCountByUserFilterTracks? filterTracks,
            global::System.Collections.Generic.IList<global::Audius.GetTracksCountByUserGateConditionItem>? gateCondition,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetTracksCountByUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string? userId,
            global::Audius.GetTracksCountByUserFilterTracks? filterTracks,
            global::System.Collections.Generic.IList<global::Audius.GetTracksCountByUserGateConditionItem>? gateCondition,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetTracksCountByUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTracksCountByUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksCountResponse> GetTracksCountByUserAsync(
            string id,
        ...
        {
            var __response = await GetTracksCountByUserAsResponseAsync(
                id: id,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksCountResponse>> GetTracksCountByUserAsResponseAsync(
            string id,
            string? userId = default,
            global::Audius.GetTracksCountByUserFilterTracks? filterTracks = default,
            global::System.Collections.Generic.IList<global::Audius.GetTracksCountByUserGateConditionItem>? gateCondition = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTracksCountByUserArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTracksCountByUserSecurityRequirements,
                operationName: "GetTracksCountByUserAsync");
            ...
            if (encodedDataSignature != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTracksCountByUserRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTracksCountByUser",
                                methodName: "GetTracksCountByUserAsync",
                                pathTemplate: "$\"/users/{id}/tracks/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTracksCountByUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTracksCountByUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.TracksCountResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.TracksCountResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.TracksCountResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
