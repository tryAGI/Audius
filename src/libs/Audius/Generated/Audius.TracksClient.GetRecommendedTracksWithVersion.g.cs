...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRecommendedTracksWithVersionSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetRecommendedTracksWithVersionSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetRecommendedTracksWithVersionSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetRecommendedTracksWithVersionSecurityRequirement0,
                s_GetRecommendedTracksWithVersionSecurityRequirement1,
            };
        partial void PrepareGetRecommendedTracksWithVersionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string version,
            ref int? limit,
            ref string? genre,
            ref global::Audius.GetRecommendedTracksWithVersionTime? time,
            global::System.Collections.Generic.IList<int>? exclusionList,
            ref string? userId);
        partial void PrepareGetRecommendedTracksWithVersionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string version,
            int? limit,
            string? genre,
            global::Audius.GetRecommendedTracksWithVersionTime? time,
            global::System.Collections.Generic.IList<int>? exclusionList,
            string? userId);
        partial void ProcessGetRecommendedTracksWithVersionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRecommendedTracksWithVersionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TracksResponse> GetRecommendedTracksWithVersionAsync(
            string version,
            int? limit = default,
        ...
        {
            var __response = await GetRecommendedTracksWithVersionAsResponseAsync(
                version: version,
                limit: limit,
                genre: genre,
                time: time,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TracksResponse>> GetRecommendedTracksWithVersionAsResponseAsync(
            string version,
            int? limit = default,
            string? genre = default,
            global::Audius.GetRecommendedTracksWithVersionTime? time = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRecommendedTracksWithVersionArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRecommendedTracksWithVersionSecurityRequirements,
                operationName: "GetRecommendedTracksWithVersionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRecommendedTracksWithVersionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetRecommendedTracksWithVersion",
                                methodName: "GetRecommendedTracksWithVersionAsync",
                                pathTemplate: "$\"/tracks/recommended/{version}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRecommendedTracksWithVersionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRecommendedTracksWithVersionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
