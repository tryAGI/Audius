...
namespace Audius
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_FavoritePlaylistSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_FavoritePlaylistSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_FavoritePlaylistSecurityRequirement2 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
                {                    new global::Audius.EndPointAuthorizationRequirement
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_FavoritePlaylistSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_FavoritePlaylistSecurityRequirement0,
                s_FavoritePlaylistSecurityRequirement1,
                s_FavoritePlaylistSecurityRequirement2,
            };
        partial void PrepareFavoritePlaylistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistId,
            ref string userId,
            global::Audius.FavoriteRequestBody request);
        partial void PrepareFavoritePlaylistRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistId,
            string userId,
            global::Audius.FavoriteRequestBody request);
        partial void ProcessFavoritePlaylistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFavoritePlaylistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> FavoritePlaylistAsync(
            string playlistId,
            string userId,
        ...
        {
            var __response = await FavoritePlaylistAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> FavoritePlaylistAsResponseAsync(
            string playlistId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFavoritePlaylistArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FavoritePlaylistSecurityRequirements,
                operationName: "FavoritePlaylistAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFavoritePlaylistRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "FavoritePlaylistAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFavoritePlaylistResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFavoritePlaylistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> FavoritePlaylistAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audius.FavoriteRequestBody
            {
                IsSaveOfRepost = isSaveOfRepost,
            };

            return await FavoritePlaylistAsync(
                playlistId: playlistId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
