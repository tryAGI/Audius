...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetPurchasesSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetPurchasesSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetPurchasesSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetPurchasesSecurityRequirement0,
                s_GetPurchasesSecurityRequirement1,
            };
        partial void PrepareGetPurchasesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref global::Audius.GetPurchasesSortMethod? sortMethod,
            ref global::Audius.GetPurchasesSortDirection? sortDirection,
            global::System.Collections.Generic.IList<string>? contentIds,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetPurchasesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId,
            global::Audius.GetPurchasesSortMethod? sortMethod,
            global::Audius.GetPurchasesSortDirection? sortDirection,
            global::System.Collections.Generic.IList<string>? contentIds,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetPurchasesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPurchasesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.PurchasesResponse> GetPurchasesAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetPurchasesAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.PurchasesResponse>> GetPurchasesAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetPurchasesSecurityRequirements,
                operationName: "GetPurchasesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("content_ids", contentIds, delimiter: ",", explode: true)
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetPurchasesAsync",
                                pathTemplate: "$\"/users/{id}/purchases\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetPurchasesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.PurchasesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.PurchasesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.PurchasesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
