...
namespace Audius
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetPlaylistAccessInfoSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetPlaylistAccessInfoSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetPlaylistAccessInfoSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetPlaylistAccessInfoSecurityRequirement0,
                s_GetPlaylistAccessInfoSecurityRequirement1,
            };
        partial void PrepareGetPlaylistAccessInfoArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistId,
            ref string? userId);
        partial void PrepareGetPlaylistAccessInfoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistId,
            string? userId);
        partial void ProcessGetPlaylistAccessInfoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPlaylistAccessInfoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.AccessInfoResponse> GetPlaylistAccessInfoAsync(
            string playlistId,
            string? userId = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetPlaylistAccessInfoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.AccessInfoResponse>> GetPlaylistAccessInfoAsResponseAsync(
            string playlistId,
            string? userId = default,
            global::Audius.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetPlaylistAccessInfoArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetPlaylistAccessInfoSecurityRequirements,
                operationName: "GetPlaylistAccessInfoAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Audius.PathBuilder(
                                path: $"/playlists/{playlistId}/access-info",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetPlaylistAccessInfoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetPlaylistAccessInfo",
                                methodName: "GetPlaylistAccessInfoAsync",
                                pathTemplate: "$\"/playlists/{playlistId}/access-info\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetPlaylistAccessInfoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetPlaylistAccessInfoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.AccessInfoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.AccessInfoResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.AccessInfoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
