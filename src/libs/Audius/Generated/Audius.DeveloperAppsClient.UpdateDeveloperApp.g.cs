...
namespace Audius
{
    ...
    {
        partial void PrepareUpdateDeveloperAppArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId,
            ref string address,
            global::Audius.UpdateDeveloperAppRequestBody request);
        partial void PrepareUpdateDeveloperAppRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            string address,
            global::Audius.UpdateDeveloperAppRequestBody request);
        partial void ProcessUpdateDeveloperAppResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateDeveloperAppResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UpdateDeveloperAppAsync(
            string userId,
            string address,
        ...
        {
            var __response = await UpdateDeveloperAppAsResponseAsync(
                userId: userId,
                address: address,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.WriteResponse>> UpdateDeveloperAppAsResponseAsync(
            string userId,
            string address,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateDeveloperAppArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateDeveloperAppRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateDeveloperAppAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateDeveloperAppResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateDeveloperAppResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.WriteResponse> UpdateDeveloperAppAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Audius.UpdateDeveloperAppRequestBody
            {
                Name = name,
            ...
            return await UpdateDeveloperAppAsync(
                userId: userId,
                address: address,
                request: __request,
                requestOptions: requestOptions,
