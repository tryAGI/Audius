...
namespace Audius
{
    public partial class UsersClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTracksByUserSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_GetTracksByUserSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_GetTracksByUserSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_GetTracksByUserSecurityRequirement0,
                s_GetTracksByUserSecurityRequirement1,
            };
        partial void PrepareGetTracksByUserArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref global::Audius.GetTracksByUserSort? sort,
            ref string? query,
            ref global::Audius.GetTracksByUserSortMethod? sortMethod,
            ref global::Audius.GetTracksByUserSortDirection? sortDirection,
            ref global::Audius.GetTracksByUserFilterTracks? filterTracks,
            global::System.Collections.Generic.IList<global::Audius.GetTracksByUserGateConditionItem>? gateCondition,
            ref string? encodedDataMessage,
            ref string? encodedDataSignature);
        partial void PrepareGetTracksByUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? userId,
            global::Audius.GetTracksByUserSort? sort,
            string? query,
            global::Audius.GetTracksByUserSortMethod? sortMethod,
            global::Audius.GetTracksByUserSortDirection? sortDirection,
            global::Audius.GetTracksByUserFilterTracks? filterTracks,
            global::System.Collections.Generic.IList<global::Audius.GetTracksByUserGateConditionItem>? gateCondition,
            string? encodedDataMessage,
            string? encodedDataSignature);
        partial void ProcessGetTracksByUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTracksByUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.Tracks> GetTracksByUserAsync(
            string id,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetTracksByUserAsResponseAsync(
                id: id,
                offset: offset,
                limit: limit,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.Tracks>> GetTracksByUserAsResponseAsync(
            string id,
            int? offset = default,
            int? limit = default,
            string? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTracksByUserArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTracksByUserSecurityRequirements,
                operationName: "GetTracksByUserAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("gate_condition", gateCondition, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTracksByUserAsync",
                                pathTemplate: "$\"/users/{id}/tracks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTracksByUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTracksByUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
