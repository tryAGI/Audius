...
namespace Audius
{
    public partial class TracksClient
    {
        ...
        partial void PrepareSearchTracksRequest(
            ...
            string? query,
            global::System.Collections.Generic.IList<string>? genre,
            global::Audius.SearchTracksSortMethod? sortMethod,
            global::System.Collections.Generic.IList<string>? mood,
            string? onlyDownloadable,
            string? includePurchaseable,
            string? isPurchaseable,
            string? hasDownloads,
            global::System.Collections.Generic.IList<string>? key,
            string? bpmMin,
            string? bpmMax);
        partial void ProcessSearchTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.TrackSearch> SearchTracksAsync(
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await SearchTracksAsResponseAsync(
                offset: offset,
                limit: limit,
                query: query,
                genre: genre,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.TrackSearch>> SearchTracksAsResponseAsync(
            int? offset = default,
            int? limit = default,
            string? query = default,
            global::System.Collections.Generic.IList<string>? genre = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareSearchTracksArguments(
                ...
                mood: mood,
                onlyDownloadable: ref onlyDownloadable,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("only_downloadable", onlyDownloadable)
                                .AddOptionalParameter("includePurchaseable", includePurchaseable)
                                .AddOptionalParameter("is_purchaseable", isPurchaseable)
                                .AddOptionalParameter("has_downloads", hasDownloads)
                                .AddOptionalParameter("key", key, delimiter: ",", explode: true)
                                .AddOptionalParameter("bpm_min", bpmMin)
                                .AddOptionalParameter("bpm_max", bpmMax)
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchTracksAsync",
                                pathTemplate: "\"/tracks/search\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.TrackSearch.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.TrackSearch>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.TrackSearch.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
