...
namespace Audius
{
    public partial class SearchClient
    {
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_SearchAutocompleteSecurityRequirement0 =
        ...
        private static readonly global::Audius.EndPointSecurityRequirement s_SearchAutocompleteSecurityRequirement1 =
            new global::Audius.EndPointSecurityRequirement
            {
                Authorizations = new global::Audius.EndPointAuthorizationRequirement[]
        ...
        private static readonly global::Audius.EndPointSecurityRequirement[] s_SearchAutocompleteSecurityRequirements =
            new global::Audius.EndPointSecurityRequirement[]
            {                s_SearchAutocompleteSecurityRequirement0,
                s_SearchAutocompleteSecurityRequirement1,
            };
        partial void PrepareSearchAutocompleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? offset,
            ref int? limit,
            ref string? userId,
            ref string? query,
            ref global::Audius.SearchAutocompleteKind? kind,
            ...
            ref double? bpmMin,
            ref double? bpmMax,
            ref global::Audius.SearchAutocompleteSortMethod? sortMethod);
        partial void PrepareSearchAutocompleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? userId,
            string? query,
            global::Audius.SearchAutocompleteKind? kind,
            ...
            double? bpmMin,
            double? bpmMax,
            global::Audius.SearchAutocompleteSortMethod? sortMethod);
        partial void ProcessSearchAutocompleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchAutocompleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.SearchAutocompleteResponse> SearchAutocompleteAsync(
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await SearchAutocompleteAsResponseAsync(
                offset: offset,
                limit: limit,
                userId: userId,
                query: query,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.SearchAutocompleteResponse>> SearchAutocompleteAsResponseAsync(
            int? offset = default,
            int? limit = default,
            string? userId = default,
            string? query = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSearchAutocompleteArguments(
            ...
            var __authorizations = global::Audius.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchAutocompleteSecurityRequirements,
                operationName: "SearchAutocompleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchAutocompleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchAutocompleteAsync",
                                pathTemplate: "\"/search/autocomplete\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchAutocompleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchAutocompleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Audius.SearchAutocompleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Audius.AutoSDKHttpResponse<global::Audius.SearchAutocompleteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Audius.SearchAutocompleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
