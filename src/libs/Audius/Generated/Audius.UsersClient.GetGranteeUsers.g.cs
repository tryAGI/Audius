...
namespace Audius
{
    ...
    {
        partial void PrepareGetGranteeUsersArguments(
            ...
            ref bool? isRevoked,
            ref string? userId);
        partial void PrepareGetGranteeUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? isRevoked,
            string? userId);
        partial void ProcessGetGranteeUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetGranteeUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Audius.FollowersResponse> GetGranteeUsersAsync(
            string address,
            int? offset = default,
            int? limit = default,
        ...
        {
            var __response = await GetGranteeUsersAsResponseAsync(
                address: address,
                offset: offset,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Audius.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Audius.AutoSDKHttpResponse<global::Audius.FollowersResponse>> GetGranteeUsersAsResponseAsync(
            string address,
            int? offset = default,
            int? limit = default,
            bool? isApproved = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetGranteeUsersArguments(
                httpClient: HttpClient,
                address: ref address,
                offset: ref offset,
                limit: ref limit,
                isApproved: ref isApproved,
                isRevoked: ref isRevoked,
                userId: ref userId);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("is_approved", isApproved?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("is_revoked", isRevoked?.ToString().ToLowerInvariant())
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Audius.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Audius.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetGranteeUsers",
                                methodName: "GetGranteeUsersAsync",
                                pathTemplate: "$\"/grantees/{address}/users\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetGranteeUsersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Audius.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetGranteeUsersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
